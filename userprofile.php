...
<div class="card border-primary border-3">
  ...
  <div class="card-img-overlay">
    ...
    <img src="assets/img/<?php echo $row['userimg'];?>" class="border border-primary" alt="profile pic" width="200" height="200">
...
<a href="classlink.php ?>" class="btn btn-danger border-primary border-3 row-col-12 text-end">Others Tutorial Links</a>
<a href="certificate.php ?>" class="btn btn-danger border-primary border-3 row-col-12 text-end">Certificate</a>
...
<div class="container">
  ...
  <table class="table text-primary bg-info">  <thead>
         <tr>
